...
public class NavigationAdapter extends ArrayAdapter<NaatKhwanModel> {

    Context mContext;
    int layoutResourceId;
    NaatKhwanModel data[] = null;

    public NavigationAdapter(Context mContext, int layoutResourceId, NaatKhwanModel[] data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NaatKhwanModel folder = data[position];
