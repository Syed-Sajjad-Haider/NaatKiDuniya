...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.AllNaatKhawanVH>  {
    ...
    public FavouriteAdapter(Context context, List<NaatsModel> downModels, List<String> song_name, AppPreferences appPreferences, DownloadInterface downloadInterface) {
    ...
    public class AllNaatKhawanVH extends RecyclerView.ViewHolder {
        ...
        private ImageView imageNaatkhawan;
        ...
        public AllNaatKhawanVH(View itemView) {
            ...
            imageNaatkhawan = itemView.findViewById(R.id.image_naatkhawan);
